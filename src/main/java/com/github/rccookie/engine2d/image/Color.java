...
public class Color {
     ...
     * (0x000000) to input a hex color value directly.</p>
     *
    ...
    public Color brighter() {
        ...
        int i = (int) (1/(1- DARKER_FACTOR));
        if(r == 0 && g == 0 && b == 0)
            return new Color(i, i, i, a);

        return new Color(Math.min((int) (Math.max(r, i)/ DARKER_FACTOR), 255),
                Math.min((int) (Math.max(g, i)/ DARKER_FACTOR), 255),
                Math.min((int) (Math.max(b, i)/ DARKER_FACTOR), 255),
                a);
    }
     ...
     */
    public Color darker() {
        return new Color(Math.max((int) (r * DARKER_FACTOR), 0),
                Math.max((int) (g * DARKER_FACTOR), 0),
                Math.max((int) (b * DARKER_FACTOR), 0),
                a);
    }


    /**
     * Returns the RGB complement of this color, i.e. every component (except alpha)
     * gets inverted.
     *
    ...
    public boolean equals(Object o) {
        return this == o || (o instanceof Color && ((Color) o).rgb == rgb);
    }
