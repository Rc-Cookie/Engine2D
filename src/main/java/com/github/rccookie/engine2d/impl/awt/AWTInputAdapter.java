...
public class AWTInputAdapter implements InputAdapter {
    ...
    public void attachKeyEvent(BiConsumer<String, Boolean> event) {
        JFrame window = AWTDisplay.latestWindow;
        window.addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {
                // These seem to be additional to the pressed and released events, so don't do anything

//                String key = getKeyString(e);
//                event.accept(key, true);
//                event.accept(key, false);
            }
    ...
    public void attachMouseEvent(Consumer<MouseData> event) {
        ...
        window.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                Point displayOnScreenPoint = AWTDisplay.latestDisplay.getLocationOnScreen();
    ...
    public boolean isMouseDataAvailable() {
        return AWTDisplay.latestWindow != null;
    }

    @Override
    public boolean isKeyDataAvailable() {
        return AWTDisplay.latestDisplay != null;
    }
